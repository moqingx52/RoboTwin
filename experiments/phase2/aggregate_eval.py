...
sys.path.append(str(Path(__file__).resolve().parents[1] / "phase1"))
...
def main():
    parser = argparse.ArgumentParser(description="Aggregate Phase 2 evaluation over training seeds.")
    ...
    for task in args.tasks:
        summary[task] = {}
        for variant in ("base", *args.variants):
            payloads = []
