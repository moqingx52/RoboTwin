#!/usr/bin/env python3
"""Schedule place Base200 Line A frozen eval on GPUs reserved for simulator work.

Two training GPUs (default 0/1) stay reserved for DP补训. Each eval GPU runs one
logical job at a time with 3 concurrent shards via run_eval_group.
"""
