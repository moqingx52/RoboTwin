...
def main():
    ...
    parser.add_argument("--rollout-dir", type=Path, default=repo_path("experiments", "capability_transport", "rollouts"))
    parser.add_argument("--output-dir", type=Path, default=repo_path("experiments", "capability_transport", "eval_results"))
    ...
    seeds_file = args.seeds_file or repo_path("experiments", "capability_transport", "seeds", f"{args.task_name}_seeds.json")
